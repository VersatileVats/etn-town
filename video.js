  ...
  if (qnaTimer.textContent == 0) {
    ...
    if (
      ...
      if (streak >= 3) {
        payUser(
          0.000007,
          `Video Q&A Game Level ${signupResult.videoLevel} completion reward`
        );
      }
    } else {
      if (
        ...
        document.querySelector("#score").textContent =
          document.querySelector("#overAllScore").textContent;
      } else document.querySelector("#overAllScore").innerHTML = 0;
